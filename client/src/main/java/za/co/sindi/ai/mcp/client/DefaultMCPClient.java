...
public class DefaultMCPClient implements MCPAsyncClient, MCPClient {
	...
	@Override
	public CallToolResult callTool(String name, Map<String, Object> arguments, ProgressHandler progressHandler) {
		// TODO Auto-generated method stub
		try {
			return callToolAsync(name, arguments, progressHandler).get();
		} catch (InterruptedException | ExecutionException e) {
			// TODO Auto-generated catch block
			client.onError(e);
			return null;
	...
	public CompletableFuture<InitializeResult> initializeAsync(ClientCapabilities clientCapabilities, Implementation clientInfo) {
		// TODO Auto-generated method stub
		return client.sendRequest(new InitializeRequest(new InitializeRequestParameters(ProtocolVersion.getLatest(), clientCapabilities, clientInfo)), InitializeResult.class);
	}
	...
	public CompletableFuture<ResourceContents[]> readResourceAsync(String uri) {
		// TODO Auto-generated method stub
		return client.sendRequest(new ReadResourceRequest(new ReadResourceRequestParameters(uri)), ReadResourceResult.class).thenApply(result -> result.getContents());
	}
	...
	public CompletableFuture<CallToolResult> callToolAsync(String name, Map<String, Object> arguments,
		...
		// TODO Auto-generated method stub
		CallToolRequestParameters parameters = new CallToolRequestParameters(name);
		parameters.setArguments(arguments);
		
		return client.sendRequest(new CallToolRequest(parameters), CallToolResult.class, progressHandler);
	}
	...
	public CompletableFuture<Completion> completeAsync(Reference reference, Argument argument) {
		// TODO Auto-generated method stub
		CompleteRequestParameters parameters = new CompleteRequestParameters(reference, argument);
		return client.sendRequest(new CompleteRequest(parameters), CompleteResult.class).thenApply(result -> result.getCompletion());
	}
