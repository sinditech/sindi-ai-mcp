...
public final class MCPSchema {
	...
	static {
		...
		requestMethods.put(CancelTaskRequest.METHOD_TASKS_RESULT, CancelTaskRequest.class);
	    ...
	    requestMethods.put(ElicitRequest.METHOD_ELICITATION_CREATE, ElicitRequest.class);
	    requestMethods.put(GetPromptRequest.METHOD_PROMPTS_GET, GetPromptRequest.class);
	    requestMethods.put(GetTaskPayloadRequest.METHOD_TASKS_RESULT, GetTaskPayloadRequest.class);
	    requestMethods.put(GetTaskRequest.METHOD_TASKS_GET, GetTaskRequest.class);
	    ...
	    notificationMethods.put(ElicitationCompleteNotification.METHOD_NOTIFICATION_LOGGING_MESSAGE, ElicitationCompleteNotification.class);
	    ...
	    notificationMethods.put(TaskStatusNotification.METHOD_NOTIFICATION_TASK_STATUS, TaskStatusNotification.class);
