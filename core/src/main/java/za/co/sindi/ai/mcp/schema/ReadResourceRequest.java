...
public final class ReadResourceRequest extends BaseRequest implements ParameterBasedRequest<ReadResourceRequestParameters>, ClientRequest {
	 ...
	 */
	@JsonbCreator
	public ReadResourceRequest(@JsonbProperty("params") ReadResourceRequestParameters parameters) {
		super();
		this.parameters = Objects.requireNonNull(parameters, "A read resource request parameters is required.");
	}
	...
	public static final class ReadResourceRequestParameters extends BaseRequestParameters {
		 ...
		 */
		@JsonbCreator
		public ReadResourceRequestParameters(@JsonbProperty("uri") String uri) {
			super();
			this.uri = Objects.requireNonNull(uri, "A resource URI is required.");
		}
